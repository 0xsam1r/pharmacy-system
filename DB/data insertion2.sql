...
-- 14) BATCH (supply batches with expiry - Multiple batches for FEFO testing)
INSERT INTO `batch` (`Batch_number`, `cost`, `expire_date`, `Quantaty`, `Product_parcode`) VALUES
-- Panadol - 3 batches with different expiry dates
('BN202501001', 22.00, '2026-06-30', 50, '62230000000123'),
('BN202501014', 22.00, '2026-03-15', 40, '62230000000123'), -- Expires earlier
('BN202501015', 21.00, '2026-09-20', 30, '62230000000123'), -- Expires later
-- Augmentin - 2 batches
('BN202501002', 95.00, '2026-02-28', 30, '62230000000124'),
('BN202501016', 95.00, '2026-01-31', 30, '62230000000124'), -- Expires earlier
-- Cataflam - 2 batches
('BN202501003', 40.00, '2026-05-31', 40, '62230000000125'),
('BN202501017', 40.00, '2026-02-28', 50, '62230000000125'), -- Expires earlier
-- Brufen - 2 batches
('BN202501004', 45.00, '2026-07-31', 50, '62230000000126'),
('BN202501018', 45.00, '2026-04-15', 50, '62230000000126'), -- Expires earlier
-- Zyrtec - 2 batches
('BN202501005', 30.00, '2026-08-31', 40, '62230000000127'),
('BN202501019', 30.00, '2026-05-20', 40, '62230000000127'), -- Expires earlier
-- Vitamin C - 2 batches
('BN202501006', 60.00, '2026-04-30', 30, '62230000000128'),
('BN202501020', 60.00, '2026-03-10', 20, '62230000000128'), -- Expires earlier
-- Rennie
('BN202501007', 28.00, '2026-03-31', 70, '62230000000129'),
-- Vicks
('BN202501008', 55.00, '2026-01-31', 30, '62230000000130'),
-- Panadol Cold & Flu - 2 batches
('BN202501009', 33.00, '2026-06-15', 50, '62230000000133'),
('BN202501021', 33.00, '2026-02-20', 60, '62230000000133'), -- Expires earlier
-- Aerius
('BN202501010', 50.00, '2027-01-31', 70, '62230000000136'),
-- Sinutab
('BN202501011', 48.00, '2026-10-31', 90, '62230000000132'),
-- Glucophage - 2 batches
('BN202501012', 62.00, '2027-02-28', 45, '62230000000134'),
('BN202501022', 62.00, '2026-08-15', 40, '62230000000134'), -- Expires earlier
-- Adol - 2 batches
('BN202501013', 26.00, '2026-11-30', 45, '62230000000135'),
('BN202501023', 26.00, '2026-07-10', 50, '62230000000135'), -- Expires earlier
-- Nivea - 2 batches
('BN202501024', 75.00, '2027-12-31', 40, '62230000000131'),
('BN202501025', 75.00, '2027-06-30', 60, '62230000000131'); -- Expires earlier
